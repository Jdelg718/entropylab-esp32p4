> **Historical D6 release record.** App-only acceptance and packaging statements below are source-bound, not qualification of the current three-image tuple. See [current status](../../../CURRENT-STATUS.md).
