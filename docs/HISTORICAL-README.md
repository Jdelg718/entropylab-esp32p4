> **Historical source-candidate landing page.** Original claims below apply only to their recorded identities, not current release availability. See [current status](CURRENT-STATUS.md). Original relative paths below use repository root.
