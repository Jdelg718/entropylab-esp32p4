...
python3 "$ROOT/scripts/test-d6-release-import.py"
python3 "$ROOT/scripts/test-review-repair-import.py"
python3 "$ROOT/scripts/test-modal-import.py"
python3 "$ROOT/scripts/test-global-saver-import.py"
