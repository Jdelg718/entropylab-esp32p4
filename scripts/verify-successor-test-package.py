...
def validate(files):
    ...
    need(p['distribution']=='HOLD' and p['hardware']=='NOT TESTED' and p['reproducibility']=='NOT TESTED' and p['writes_enabled'] is False and p['diagnostics_enabled'] is False,'assurance scope')
    ...
    need(profile['assets']==assets and profile['profileId']==VERSION and profile['writeHold'] is True,'adapter pins/hold')
    ...
    need("if (this.#p.writeHold) fail('SUCCESSOR_TEST_HOLD');" in adapter,'enforced hold')
